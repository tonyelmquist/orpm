...
function properties_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0){
	...
	$combo_type->Render();
	$combo_owner->HTML = '<span id="owner-container' . $rnd1 . '"></span><input type="hidden" name="owner" id="owner' . $rnd1 . '" value="' . htmlspecialchars($combo_owner->SelectedData) . '">';
	$combo_owner->MatchText = '<span id="owner-container-readonly' . $rnd1 . '"></span><input type="hidden" name="owner" id="owner' . $rnd1 . '" value="' . htmlspecialchars($combo_owner->SelectedData) . '">';
	...
	$parent_tables = array(  'rental_owners' => array('owner', 'Owner'));
