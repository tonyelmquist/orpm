...
require_once("$d/incCommon.php");
   ...
   //Task : Implement access only to loggedIn users.
   $mi = getMemberInfo();

   if(!$mi['username'] || $mi['username'] == 'guest'){
      echo "Sorry, you don't have authority to access this page.";
      echo '<script language="javaScript">setInterval("window.location=\'/C:/xampp/htdocs/orpm/index.php?signOut=1\'", 2000);</script>';
      exit;
   }
