...
function rental_owners_insert(){
	...
	sql("insert ignore into membership_userrecords set tableName='rental_owners', pkValue='$recID', memberID='".getLoggedMemberID()."', dateAdded='".time()."', dateUpdated='".time()."', groupID='".getLoggedGroupID()."'", $eo);
