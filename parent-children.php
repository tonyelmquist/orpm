		...
		$pcConfig = array(
			...
			'residence_and_rental_history' => array(   
				'tenant' => array(   
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(2 => 'Month', 3 => 'Monthly rent', 4 => 'Security deposit', 5 => 'Other charges', 6 => 'Rent Paid', 7 => 'Rent Balance', 8 => 'Rent Reminder Date', 9 => 'Due date', 10 => 'Late Rent Reminder Date', 11 => 'Duration of residency from', 12 => 'to', 13 => 'Reason for leaving'),
					'display-field-names' => array(2 => 'month', 3 => 'monthly_rent', 4 => 'security_deposit', 5 => 'other_charges', 6 => 'rent_paid', 7 => 'rent_balance', 8 => 'rent_reminder', 9 => 'due_date', 10 => 'late_rent_reminder', 11 => 'duration_of_residency_from', 12 => 'to', 13 => 'reason_for_leaving'),
					'sortable-fields' => array(0 => '`residence_and_rental_history`.`id`', 1 => '`residence_and_rental_history`.`tenant`', 2 => '`residence_and_rental_history`.`month`', 3 => '`residence_and_rental_history`.`monthly_rent`', 4 => '`residence_and_rental_history`.`security_deposit`', 5 => '`residence_and_rental_history`.`other_charges`', 6 => '`residence_and_rental_history`.`rent_paid`', 7 => '`residence_and_rental_history`.`rent_balance`', 8 => '`residence_and_rental_history`.`rent_reminder`', 9 => '`residence_and_rental_history`.`due_date`', 10 => '`residence_and_rental_history`.`late_rent_reminder`', 11 => '`residence_and_rental_history`.`duration_of_residency_from`', 12 => '`residence_and_rental_history`.`to`', 13 => '`residence_and_rental_history`.`reason_for_leaving`', 14 => '`residence_and_rental_history`.`notes`'),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
