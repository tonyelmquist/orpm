		...
		$pcConfig = array(
			...
			'residence_and_rental_history' => array(   
				'tenant' => array(   
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(2 => 'Monthly rent', 3 => 'Security deposit', 4 => 'Rent Paid', 5 => 'Rent Balance', 6 => 'Rent Reminder Date', 7 => 'Late Rent Reminder Date', 8 => 'Duration of residency from', 9 => 'to', 10 => 'Reason for leaving'),
					'display-field-names' => array(2 => 'monthly_rent', 3 => 'security_deposit', 4 => 'rent_paid', 5 => 'rent_balance', 6 => 'rent_reminder', 7 => 'late_rent_reminder', 8 => 'duration_of_residency_from', 9 => 'to', 10 => 'reason_for_leaving'),
					'sortable-fields' => array(2 => '3', 3 => '4', 4 => '5', 5 => '6', 6 => '`residence_and_rental_history`.`rent_reminder`', 7 => '`residence_and_rental_history`.`late_rent_reminder`', 8 => '`residence_and_rental_history`.`duration_of_residency_from`', 9 => '`residence_and_rental_history`.`to`', 10 => '11'),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
