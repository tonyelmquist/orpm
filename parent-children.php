		...
		$pcConfig = array(
			...
			'residence_and_rental_history' => array(   
				'tenant' => array(   
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(2 => 'Monthly rent', 3 => 'Security deposit', 4 => 'Other charges', 5 => 'Rent Paid', 6 => 'Rent Balance', 7 => 'Rent Reminder Date', 8 => 'Due date', 9 => 'Late Rent Reminder Date', 10 => 'Duration of residency from', 11 => 'to', 12 => 'Reason for leaving'),
					'display-field-names' => array(2 => 'monthly_rent', 3 => 'security_deposit', 4 => 'other_charges', 5 => 'rent_paid', 6 => 'rent_balance', 7 => 'rent_reminder', 8 => 'due_date', 9 => 'late_rent_reminder', 10 => 'duration_of_residency_from', 11 => 'to', 12 => 'reason_for_leaving'),
					'sortable-fields' => array(0 => '`residence_and_rental_history`.`id`', 1 => '`residence_and_rental_history`.`tenant`', 2 => '`residence_and_rental_history`.`monthly_rent`', 3 => '`residence_and_rental_history`.`security_deposit`', 4 => '`residence_and_rental_history`.`other_charges`', 5 => '`residence_and_rental_history`.`rent_paid`', 6 => '`residence_and_rental_history`.`rent_balance`', 7 => '`residence_and_rental_history`.`rent_reminder`', 8 => '`residence_and_rental_history`.`due_date`', 9 => '`residence_and_rental_history`.`late_rent_reminder`', 10 => '`residence_and_rental_history`.`duration_of_residency_from`', 11 => '`residence_and_rental_history`.`to`', 12 => '`residence_and_rental_history`.`reason_for_leaving`', 13 => '`residence_and_rental_history`.`notes`'),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
			...
			'units' => array(   
				'property' => array(   
					...
					'sortable-fields' => array(0 => '`units`.`id`', 1 => '`units`.`property`', 2 => '`units`.`unit_number`', 3 => '`units`.`photo`', 4 => '`units`.`status`', 5 => '`units`.`features`', 6 => '`units`.`rental_amount`', 7 => '`units`.`deposit_amount`', 8 => '`units`.`description`'),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
