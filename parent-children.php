		...
		$pcConfig = array(
			...
			'properties' => array(   
				'owner' => array(   
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(1 => 'Property Name', 2 => 'Type', 3 => 'Number of units', 4 => 'Photo', 5 => 'Owner', 7 => 'County', 8 => 'Area', 9 => 'Street / Road', 10 => 'ZipCode'),
					'display-field-names' => array(1 => 'property_name', 2 => 'type', 3 => 'number_of_units', 4 => 'photo', 5 => 'owner', 7 => 'street', 8 => 'City', 9 => 'State', 10 => 'zipCode'),
					'sortable-fields' => array(0 => '`properties`.`id`', 1 => '`properties`.`property_name`', 2 => '`properties`.`type`', 3 => '`properties`.`number_of_units`', 4 => '`properties`.`photo`', 5 => '`properties`.`owner`', 6 => '`properties`.`country`', 7 => '`properties`.`street`', 8 => '`properties`.`City`', 9 => '`properties`.`State`', 10 => '`properties`.`zipCode`'),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
