<?php /* Smarty version 2.6.18, created on 2016-10-28 08:59:59
         compiled from ../modules/tax_rates/manage.js.php */ ?>
...
<?php echo '\', name : \'tax_description\', width : 40 * percentage_width, sortable : true, align: \'left\'},
				{display: \''; ?>
<?php echo $this->_tpl_vars['LANG']['rate']; ?>
<?php echo '\', name : \'tax_percentage\', width : 30 * percentage_width, sortable : true, align: \'left\'},
				{display: \''; ?>
...
<?php echo '\', name : \'tax_id\'},
				{display: \''; ?>
<?php echo $this->_tpl_vars['LANG']['description']; ?>
<?php echo '\', name : \'tax_description\', isdefault: true}
				],
