<?php
	...
	$schema = array(   
		...
		'residence_and_rental_history' => array(   
			...
			'unit' => array('appgini' => 'VARCHAR(40) '),
			'monthly_rent' => array('appgini' => 'DECIMAL(10,2) unsigned '),
			'security_deposit' => array('appgini' => 'DECIMAL(10,2) unsigned '),
			'other_charges' => array('appgini' => 'DECIMAL(10,2) unsigned '),
			'rent_paid' => array('appgini' => 'DECIMAL(10,2) unsigned default \'0.00\' '),
			...
			'status' => array('appgini' => 'VARCHAR(40) default \'BALANCE\' '),
		...
		'applicants_and_tenants' => array(   
			...
			'first_name' => array('appgini' => 'VARCHAR(100) '),
