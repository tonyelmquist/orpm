				...
				<table class="table">
					...
					<tr>
						<td align="center">
							...
							<?php
								$arrFields = array('', 'applications_leases', 'residence_and_rental_history', 'employment_and_income_history', 'references', 'applicants_and_tenants', 'properties', 'units', 'rental_owners', 'audit_trail', 'maintenance_tasks', 'employees', 'task_types');
								$arrFieldCaptions = array('All tables', 'Applications/Leases', 'Rental history', 'Employment and income history', 'References', 'Tenant Center', 'Property Center', 'Units Center', 'Owners Center', 'Audit Trail', 'Maintenance tasks', 'Employees', 'Task types');
