	...
	*/
	...
	function getTableList($skip_authentication = false){
		...
		$arrTables = array(   
			...
			'units' => array('Unit ', 'Listing of all units, its details and current status.', 'resources/table_icons/change_password.png', 'None'),
