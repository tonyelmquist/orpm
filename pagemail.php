<?php
	...
	//require("admin/incCommon.php");
	//include("admin/incHeader.php");
	include("admin/../db.php");
	include("admin/../settings-manager.php");
	...
	include("admin/../language-admin.php");
	...
	// begin sending emails
		...
		$currDir = dirname(__FILE__);
		if(!$fp=fopen("admin/$queueFile.php", "w")){
			?>
			<div class="alert alert-danger">
